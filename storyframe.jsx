...
export default function StoryFrame() {
  ...
  const fso = (() => {
    ...
    if(frame==="polaroid")  return {...b, background:"#fff", padding:"3% 3% 9% 3%",  borderRadius:3};
  ...
  const controlsJSX = (
    <div style={{ display:"flex", flexDirection:"column", gap:20, padding:"4px 2px" }}>
      ...
      <Slider label="Photo Size" value={scale} min={20} max={90} onChange={setScale} />
  ...
  return (
    <div style={{ minHeight:"100vh", background:"#080810", color:"#fff", fontFamily:"'Inter',system-ui,sans-serif", display:"flex", flexDirection:"column" }}>
      ...
      <div className="sf-mobile" style={{ position:"fixed", bottom:0, left:0, right:0, zIndex:100, background:"transparent", backdropFilter:"blur(16px)", WebkitBackdropFilter:"blur(16px)", borderTop:"1px solid rgba(255,255,255,0.1)" }}>
